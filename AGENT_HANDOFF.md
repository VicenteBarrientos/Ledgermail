...
| 2026-07-13 | Prod API 500 root cause: `Cannot find module @ledgermail/shared/src/index.ts` — Vercel entry imported TS workspace packages. Fix: esbuild → `api/server.js`, thin `api/index.ts` requires bundle only. |
